...
public class A_StringMethods {
	...
	public static void main(String[] args) {
         ...
         */ // contains den farký indexini verir, contains ise true false
        // 012345678
        String text = "Good";
        System.out.println("G harfinin indexi = " + text.indexOf("G")); // indexler 0 dan baþlar
        System.out.println("d harfinin indexi = " + text.indexOf('d')); //3
        System.out.println("H harfinin indexi = " + text.indexOf("H")); // -1  : bulunamadý, yok
        System.out.println("od nin indexi = " + text.indexOf("od")); // 2 : var ise ilk harfin indexini verir
        int index = text.indexOf("o"); // int deðiþkene atanabilir. küçük o harfi
        System.out.println("index = " + index); // 1 :  ayný karakterden birden fazla var ise ilkini verir.
        ...
        /** lastIndexOf()
         *  String içinde aranan karakter(ler)in sondan itibaren ilk indexini varýr
         *  indexOf un sondan olan hali fakat index numaralarý deðiþmez.
         */
        ...
        System.out.println("ilk baþtan i nun indexi = " + textt.indexOf("i")); //6
        System.out.println("----------");
        /**
         * charAt()
         * Ýstenen noktadaki karakteri verir,
         * karakterlerin sýrasý 0 dan baþlar, buna index denir.
        ...
        /** ReplaceFirst
        * Replace ile ayný sadece ilk bulunaný deðiþtirir
         */
        String txt = "Merhaba Dunya";

        System.out.println("orjinal hali = " + txt); //orjinal hali = Merhaba Dunya
        System.out.println("butun a larýn nýn degistigi hali = " + txt.replace("a", "e"));
        // butun a larýn nýn degistigi hali = Merhebe Dunye
        System.out.println("ilk bulunan a nýn degistigi hali = " + txt.replaceFirst("a", "e"));
        // ilk bulunan a nýn degistigi hali = Merheba Dunya
        System.out.println("----------");
        /** replaceAll()
         *
         */
         ...
         * bir stringin içerisinde karakter(ler)in var olup olmadýðýný kontrol eder.
         * Sonuc boolean dir.
         *
         * equals()
         * 2 String metnin birbirine esit olup olmadigina bakar. büyük küçük harf farký vardýr. Sonuc boolean dir.
         *
         * equalsIgnorecase()
        ...
        System.out.println("Eþit mi = " + str.equalsIgnoreCase("mERHaba")); // true
        System.out.println("Eþit mi = " + str.equalsIgnoreCase("mERHa")); // false
    ...
    * bir stringe diðerini ekler
     ...
     * */
        ...
        s = s.concat(s2);// yani degiskenin kendisine atama yapýlýrsa degeri kalici degisir.
        // s= s+s2; ayný islemi yapar.
        System.out.println("s = " + s); // s = Hi everybody
        System.out.println("----------");
        /**
         * StringIsEmpty
         *  String tamamen boþ mu deðil mi onu kontrol ediyor, sonuç true false
         */
        String str1 = "Hi";
        System.out.println("str1 içi boþ mu = " + str1.isEmpty()); //false

        String str2 = "";
        System.out.println("str2 içi boþ mu = " + str2.isEmpty()); //true
        ...
        System.out.println(str4.toUpperCase()); //TECHPROEDUCATÝON
        ...
        System.out.println(str4);  //TECHPROEDUCATÝON
