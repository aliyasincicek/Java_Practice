...
public class a_arrays {
	...
	public static void main(String[] args) {
	    ...
	    NOT 2 : Bir Array’de olmayan index’i kullanmak isterseniz “ArraysIndexOutOfBoundsException” hatasý alirsiniz.

	     Multi Dimesional Array :
	    Deger Atama -->int arr[][] = { {1, 2}, {3}, {4, 5, 6, 7}, {8, 9} };
	    yazdýrma-->System.out.println(Arrays.deepToString(arr));
