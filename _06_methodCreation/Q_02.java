...
public class Q_02 {
  ...
  public static void isimBirlestir(String isim1,String isim2){  // burada ki isim1 ile isim2 yukarýdakilerle ayný deðil. farklý parametreler
    if (isim1.length()%2==0) {
        ...
        System.out.println("isim1 cift sayili olmadigi icin ortasina yerlestiremedik");
                                                                                               ...
                                                                                               // burasý da diðer yarýsý.. burasý da bir sayý olarak dönüyor
  // System.out.println(isim1.substring(0, (isim1.length()/2)).concat(isim2).concat(isim1.substring(isim1.length()/2 ))); mesela substring (2)
                        //              burasý bir sayý olarak dönüyor. 0 dan girilen çift haneli ismin yarýsý 
